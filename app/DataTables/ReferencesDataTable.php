...
class ReferencesDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('action', function ($reference) {
                return '<a href="references/'.$reference->id.'/edit" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit</a>';
            });
    }
    ...
    {
        return 'References_' . date('YmdHis');
    }
