...
class DraftContractsController extends Controller
{
    ...
    public function ptomniintivision_pkwt($contract)
    {
        ...
        $y+=5;
        PDF::SetXY($x, $y);
        PDF::MultiCell(170,5,"Perjanjian Kerja Untuk Waktu Tertentu ini dibuat dan ditandatangani pada hari ini, <b>".$contract->contract_date->format('l')."</b>, tanggal <b>".$contract->contract_date->format('d F Y')."</b>, oleh dan antara:",0,'L',0,1,'','',true,0,true);
        ...
        PDF::SetXY($x+10, $y);
        PDF::MultiCell(165,5,"Perjanjian ini dibuat untuk jangka waktu <b>12 (dua belas) bulan</b> terhitung sejak tanggal <b>15 Januari 2019</b>, sampai dengan tanggal <b>14 Januari 2020</b> dan dapat diperpanjang dengan pemberitahuan secara tertulis oleh <b>Pihak Pertama</b> kepada <b>Pihak Kedua</b> dalam waktu 7 (tujuh) hari sebelum jangka waktu Perjanjian ini berakhir.",0,'J',0,1,'','',true,0,true);
