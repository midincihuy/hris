...
class PrintController extends Controller
{
    ...
    public function ptomniintivision_promosi($sk){
        $x = 20;
        $y = 30;
        PDF::SetTitle('Print '.$sk->jenis_surat);
        PDF::SetAutoPageBreak(true);
        ...
        $y=PDF::getY();
        PDF::SetXY($x, $y);
        PDF::MultiCell(170,5,"Promosi Jabatan sebagai ".$sk->employee->position->name,0,'C');
        ...
        PDF::SetXY($x+40, $y);
        PDF::MultiCell(120,5,"Usulan Promosi No. ".$sk->ref_no,0,'L',0,1,'','',true,0,true);
        ...
        $y=PDF::getY()+5;
        PDF::SetXY($x, $y);
        PDF::MultiCell(150,5,"Terhitung mulai tanggal <b>".$sk->start_date->formatLocalized("%d %B %Y")."</b>, Saudara dipromosikan sebagai <b>".$sk->employee->position->name."</b> di Departemen ".$sk->employee->position->department->name.", Divisi ".$sk->employee->position->division->name.", ".$sk->employee->position->company.", dengan menjalani masa percobaan sampai dengan tanggal <b>".$sk->end_date->formatLocalized("%d %B %Y")."</b>.",0,'J',0,1,'','',true,0,true);
        ...
        $y=PDF::getY()+25;
        PDF::SetXY($x, $y);
        PDF::MultiCell(150,5,"<u>Sutanto Hartono</u>",0,'L',0,1,'','',true,0,true);
        $y=PDF::getY();
        PDF::SetXY($x, $y);
        PDF::MultiCell(150,5,"Direktur",0,'L',0,1,'','',true,0,true);
    ...
    public function ptomniintivision_pkwt($contract)
    {
        ...
        PDF::SetXY($x+5, $y);
        PDF::MultiCell(165,5,"<b>PT. OMNI INTIVISION</b>, suatu perseroan terbatas berkedudukan di Jakarta, SCTV Tower, Jalan Asia Afrika Lot 19, Jakarta 10270,dalam hal ini diwakili oleh <b>Andriane Tjepaka Dewi</b>, yang bertindak dalam jabatannya selaku <b><i>HRGA Division Head</i></b> dari dan oleh karenanya sah bertindak untuk dan atas nama serta mewakili kepentingan PT Omni Intivision (untuk selanjutnya disebut <b>\"Pihak Pertama/ Pengusaha\"</b>); dan ",0,'J',0,1,'','',true,0,true);
    ...
    public function ptelangprimaretailindo_pkwt($contract)
    {
        ...
        PDF::MultiCell(5,5,"<b>1.</b>",0,'L',0,1,'','',true,0,true);
        PDF::SetXY($x+5, $y);
        PDF::MultiCell(165,5,"<b>PT. Elang Prima Retailindo</b>, suatu perseroan terbatas berkedudukan di Jakarta, SCTV Tower, Jalan Asia Afrika Lot 19, Jakarta 10270,dalam hal ini diwakili oleh <b>Sri Dewi</b>, yang bertindak dalam jabatannya selaku <b><i>Director</i></b> dari dan oleh karenanya sah bertindak untuk dan atas nama serta mewakili kepentingan PT Elang Prima Retailindo (untuk selanjutnya disebut <b>\"Pihak Pertama/ Pengusaha\"</b>); dan ",0,'J',0,1,'','',true,0,true);
    ...
    public function ptomniintivision_probation($contract)
    {
        ...
        PDF::MultiCell(10,5,"2.1.",0,'L',0,1,'','',true,0,true);
        PDF::SetXY($x+10, $y);
        PDF::MultiCell(165,5,"<b>Pihak Kedua</b> setuju untuk bekerja efektif tanggal <b>".$contract->contract_date->formatLocalized('%d %B %Y')."</b> dengan Masa Percobaan selama <b>".$contract->contract_duration." (".Terbilang::make($contract->contract_duration).") bulan</b> terhitung mulai tanggal tersebut sampai dengan tanggal <b>".$contract->contract_expire_date->formatLocalized('%d %B %Y')."</b>.",0,'J',0,1,'','',true,0,true);
    ...
    public function ptomniintivision_add($contract)
    {
        ...
        PDF::SetXY($x+5, $y);
        PDF::MultiCell(165,5,"<b>PT. OMNI INTIVISION</b>, SCTV Tower, Jalan Asia Afrika Lot 19, Jakarta 10270, diwakili oleh <b>Andriane Tjepaka Dewi</b> yang bertindak dalam jabatannya selaku <b><i>HRGA Division Head</i></b> dari dan oleh karenanya sah bertindak untuk dan atas nama serta mewakili kepentingan PT Omni Intivision (untuk selanjutnya disebut <b><i>\"Pihak Pertama/ Pengusaha\"</i></b>); dan ",0,'J',0,1,'','',true,0,true);
        ...
        $y=PDF::getY()+5;
        PDF::SetXY($x, $y);
        PDF::MultiCell(170,5,"<b>Pihak Pertama</b> dan <b>Pihak Kedua</b> untuk selanjutnya secara bersama-sama disebut <b><i>\"Para Pihak\"</i></b> dan masing-masing daripadanya disebut <b><i>\"Pihak\"</i></b>.",0,'J',0,1,'','',true,0,true);
        ...
        PDF::MultiCell(6,5,"A.",0,'L',0,1,'','',true,0,true);
        PDF::SetXY($x+5, $y);
        PDF::MultiCell(165,5,"bahwa Para Pihak telah menandatangani Perjanjian Kerja Waktu Tertentu No. $contract->contract_reference_no tanggal ".$contract->contract_date->formatLocalized('%d %B %Y')." (untuk selanjutnya disebut <b><i>\"Perjanjian\"</i></b>) tentang penunjukan <b>Pihak Kedua</b> untuk bekerja di perusahaan <b>Pihak Pertama</b> sebagai karyawan tidak tetap sebagai <b>".$contract->position->name."</b> pada <b><i>".$contract->position->department->name." Department, ".$contract->position->division->name." Division</i></b> untuk jangka waktu ".$contract->parent->contract_duration." bulan, yaitu tanggal ".$contract->parent->contract_date->formatLocalized("%d %B %Y")." sampai dengan tanggal ".$contract->parent->contract_expire_date->formatLocalized("%d %B %Y")."; dan",0,'J',0,1,'','',true,0,true);

        $y=PDF::getY()+5;
        PDF::SetXY($x, $y);
        PDF::MultiCell(6,5,"B.",0,'L',0,1,'','',true,0,true);
        PDF::SetXY($x+5, $y);
        PDF::MultiCell(165,5,"bahwa Para Pihak bermaksud mengaddendum jangka waktu Perjanjian untuk $contract->contract_duration bulan berikutnya.",0,'J',0,1,'','',true,0,true);
        ...
        $y=PDF::getY()+5;
        PDF::SetXY($x, $y);
        PDF::MultiCell(165,5,"Demikianlah Addendum I ini dibuat dalam rangkap 2 (dua) yang sama bunyinya dan masing-masing serta ditandatangani oleh Para Pihak di Jakarta pada tanggal <b>".$contract->contract_date->formatLocalized("%d %B %Y")."</b> sehingga keduanya memiliki kekuatan hukum yang sama bagi Para Pihak.",0,'J',0,1,'','',true,0,true);
    ...
    public function ptelangprimaretailindo_add($contract)
    {
        $x = 1;
        $y = 30;
        PDF::SetTitle('Print '.$contract->contract_type);
        ...
        PDF::MultiCell(5,5,"1.",0,'L',0,1,'','',true,0,true);
        PDF::SetXY($x+5, $y);
        PDF::MultiCell(165,5,"<b>PT. ELANG PRIMA RETAILINDO</b>, SCTV Tower, Jalan Asia Afrika Lot 19, Jakarta 10270, diwakili oleh <b>Sri Dewi</b> yang bertindak dalam jabatannya selaku <b><i>Direktur</i></b> dari dan oleh karenanya sah bertindak untuk dan atas nama serta mewakili kepentingan PT Omni Intivision (untuk selanjutnya disebut <b><i>\"Pihak Pertama/ Pengusaha\"</i></b>); dan ",0,'J',0,1,'','',true,0,true);
        ...
        $y=PDF::getY()+5;
        PDF::SetXY($x, $y);
        PDF::MultiCell(170,5,"<b>Pihak Pertama</b> dan <b>Pihak Kedua</b> untuk selanjutnya secara bersama-sama disebut <b><i>\"Para Pihak\"</i></b> dan masing-masing daripadanya disebut juga <b><i>\"Pihak\"</i></b>.",0,'J',0,1,'','',true,0,true);
        ...
        PDF::MultiCell(6,5,"A.",0,'L',0,1,'','',true,0,true);
        PDF::SetXY($x+5, $y);
        PDF::MultiCell(165,5,"bahwa Para Pihak telah menandatangani Perjanjian Kerja Waktu Tertentu No. $contract->contract_reference_no tanggal ".$contract->contract_date->formatLocalized('%d %B %Y')." (untuk selanjutnya disebut <b><i>\"Perjanjian\"</i></b>) tentang penunjukan <b>Pihak Kedua</b> untuk bekerja di perusahaan <b>Pihak Pertama</b> sebagai karyawan tidak tetap sebagai <b>".$contract->position->name."</b> pada <b>".$contract->position->department->name." Department, ".$contract->position->division->name." Division</b> untuk jangka waktu ".$contract->parent->contract_duration." bulan, yaitu tanggal ".$contract->parent->contract_date->formatLocalized("%d %B %Y")." sampai dengan tanggal ".$contract->parent->contract_expire_date->formatLocalized("%d %B %Y")."; dan",0,'J',0,1,'','',true,0,true);
        ...
        $y=PDF::getY();
        PDF::SetXY($x, $y);
        PDF::MultiCell(150,5,"PT ELANG PRIMA RETAILINDO",0,'L',0,1,'','',true,0,true);

        $y=PDF::getY()+15;
        PDF::SetXY($x, $y);
        PDF::MultiCell(50,5,"<u>Sri Dewi</u>",0,'L',0,1,'','',true,0,true);
        ...
        $y=PDF::getY();
        PDF::SetXY($x, $y);
        PDF::MultiCell(150,5,"<i>Direktur</i>",0,'L',0,1,'','',true,0,true);
